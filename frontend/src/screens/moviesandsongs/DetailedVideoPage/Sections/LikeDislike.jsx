  ...
  return (
    <React.Fragment>
      <span key="comment-basic-like">
        <Tooltip title="Like">
          {isLiked === 'liked' ? (
            <LikeFilled style={{ color: 'rgb(37, 141, 252)' }} onClick={onLike} />
          ) : (
            <LikeOutlined style={{ color: 'rgb(37, 141, 252)' }} onClick={onLike} />
          )}
        </Tooltip>
      ...
      <span key="comment-basic-dislike">
        <Tooltip title="Dislike">
          {isDisliked === 'disliked' ? (
            <DislikeFilled style={{ color: 'rgb(37, 141, 252)' }} onClick={onDislike} />
          ) : (
            <DislikeOutlined style={{ color: 'rgb(37, 141, 252)' }} onClick={onDislike} />
          )}
        </Tooltip>
